...
**character**:&nbsp; text, always between quotes:  
    - `"hello R"` or `"GATC"`  
**factor**:&nbsp; nominal and ordinal scales (_not dealt with here_)  
...
(The file can be downloaded here: https://raw.githubusercontent.com/MichielNoback/intro_R_lessons/master/data/protein_processing_pred.csv)
